...
document.addEventListener("DOMContentLoaded", function () {
    addEventListener('change', function (eventData){
        ...
        let chartutilities = document.getElementById('Putilities').value;
        ...
        document.getElementById("Pieutilties").innerText = (((Math.round((chartutilities / netMonthly)*100.00)) + '%'));
        ...
        let chartremainder = ((Math.round((netMonthly - chartsavings - charthousing - chartutilities - charttransportation - chartstudentloans - chartfood - chartclothing - chartpersonal)*100)/100));
